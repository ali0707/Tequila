                    ...
                    <div class="col-lg-12">
                      <div class="contenet-hero">
                        ...
                        <a href="#" class="view-case scroll-down scroll-to">
                          Scroll Down{" "}
                          <img
                            src="./Assets/img/arrow-right-wight.png"
                            alt=""
                          />
                        </a>
                      </div>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="pro-text">
                      <h4 data-dsn-animate="up">
                        We are selling a lifestyle paired with emotions hype,
                        good vibes <br />
                      ...
                      <p data-dsn-animate="up">
                        ...
                        Instagram gallery feed, influencer marketing and
                        exclusive events worldwide. Inspired by the work of
                        legendary photographers Slim Aarons, Mario Testino, we
                        already started creating content celebrating the
                        unapologetically glamorous lifestyle portrayed by these
                        masters.
                      </p>
                    </div>
                  </div>
                    ...
                    <div class="row align-items-center h-100">
                      ...
                      <div class="col-lg-5 offset-lg-1">
                        ...
                        <div class="content">
                          ...
                          <p>
                            We won the Best Workplace award from Great Place to
                            Work 3 times in Finland, and once in all of Europe.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="services-item">
                          ...
                          <p>
                            ...
                            products. Our logo is defined by two distinct
                            elements The toltec Cyclops symbol discovered in the
                            ancient cave located in mexico. The Eétreo agave
                            plant Surounding our logo as a crown /sun to enhance
                            the importance of our tequila flavors
                          </p>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="services-item">
                          ...
                          <p>
                            The founders, from all across the globe, met one
                            night at an exclusive nightclub in London. After
                            several tequila shots and despite barely meeting,
                            the newfound group of friends spontaneously booked
                            flights to Ibiza and shared more epic memories
                            together, including being backstage with Black
                            Coffee. The friends wanted to share their
                            out-of-body experience with the world, and Etéreo
                            was born.
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="services-item">
                          <div class="line-before"></div>
                          <h4 class="subtitle">
                            “WE ARE CREATING MORE THAN A TEQUILA, WE ARE
                            PURVIVING A LIFESTYLE.
                          </h4>
                          <p>
                            Our logo was also carefully curated to evoke the
                            “Etéreo” brand, which is combined of two designs:
                            (1) an ancient Toltec petroglyph discovered
                            thousands of years ago in a Mexican cave resembling
                            a one-eyed creature described as “out of this
                            world”; and (2) the blue weber agave plant as an
                            ornament on top of its head. Our logo is timeless
                            and intended to pay homage to the Mexican heritage.{" "}
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="services-item">
                          ...
                          <p>
                            ...
                            moments and memories that define your unique
                            lifestyle, and it is the perfect description when
                            you take a sip of Etéreo—a true out-of-body
                            experience.
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="client-item">
                        <div>
                          <p>
                            ...
                            peppery, intriguing, very long ripe melons, toffee,
                            and white pepper finish. A tantalizing melange of
                            complex flavors that reward each sip
                          </p>
                          <h5>ali ben said</h5>
                        </div>
                      </div>
