...
export default function Events() {
    return (
        <div class=" hamburger-menu dsn-effect-scroll dsn-ajax"
                            ...
                            <div class="project-title" id="dsn-hero-parallax-title">
                                <div class="title-text-header">
                                    ...
                                    <span class="title-text-header-inner">
                                        <span data-dsn-animate="ajax">THE CHAMPION
                                            USMAN84</span>
                                    </span>
                                </div>
                                    ...
                                    <div class="row align-items-center h-100">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="box-info">
                                                ...
                                                <h6 data-dsn-animate="up">The essence of Etéreo is that our tequila is made without
                                                    compromise from the field to bottle using ancestral methods
                                                    that ensures our flavors are distinctly “out of this world.”.</h6>

                                                <p data-dsn-animate="up">ETÉREO is taking a diferent turn
                                                    on tequila’s traditional folkloric approach.</p>

                                                <div class="link-custom" data-dsn-animate="up">
                                                    <a class="image-zoom" href="AboutUs" data-dsn="parallax">
